...
SendBotMsg = function (content, msg, log) {
	...
	if (log && log == true) messages[msg.author.id][userdata[msg.author.id][0]]=([0, content]);
...
SendBotMsgINCodeBlock = function (content, msg, before, after, log) {
	...
	if (log && log == true) messages[msg.author.id][userdata[msg.author.id][0]]=([1, [content,before,after]]);
